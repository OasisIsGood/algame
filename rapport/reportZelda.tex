...
diverses méthodes de cr\'eation d'objet.
...
\subsubsection*{un Singleton pour g�rer le nombre d'ennemis dans le niveau}
...
Une des principales difficult\'es f\^ut de g\'erer correctement les sprites. 
